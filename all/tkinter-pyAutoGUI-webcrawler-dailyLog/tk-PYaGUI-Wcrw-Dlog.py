...
#                   2. O WSL2 não tem suporte nativo para interfaces graficas. Para visualizar interfaces gráficas no WSL2, você precisará de um servidor X (X server) no Windows. O X server permitirá que você visualize janelas gráficas.
